...
public class RegisterTest extends TestBase{
	...
	public void testRegistration(String fname, String lname, String email,String passwd,String confpasswd,String testType ) throws IOException{
		...
		getObject("register_fname").sendKeys(fname);
		getObject("register_lname").sendKeys(lname);
		getObject("register_email").sendKeys(email);
		getObject("register_passwd").sendKeys(passwd);
		getObject("register_confpasswd").sendKeys(confpasswd);
